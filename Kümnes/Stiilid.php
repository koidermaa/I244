...
<body>
    ...
    <form method="POST" action="?">
        <textarea name="text" <?php if(!empty($_POST['text'])) {echo "placeholder=\"".htmlspecialchars($_POST['text'])."\" ";} else {echo "placeholder=\"sisesta tekst siia\" ";} ?>></textarea>
        <br/>
